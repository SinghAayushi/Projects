  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen bg-gray-100 py-12 px-4">
      <h1 className="text-3xl font-bold text-center mb-8 ">
        Srimad Bhagavad Gita! - Privacy Policy
      </h1>
      <div className="w-full max-w-3xl text-gray-700 space-y-6">
        <p>
          <b>Srimad Bhagavad Gita!</b> is built by Aayushi Singh. This
        ...
        <p>
          <b>Srimad Bhagavad Gita</b> prioritizes your privacy. We do not
        ...
        <p>
          Your user actions and any verses you share within the app are
          stored locally on your device. We do not access or store this
          information on our servers. This ensures your privacy and keeps your experience entirely personal.
        </p>
        ...
        <p>
          <b>Srimad Bhagavad Gita!</b> does not currently integrate with any
