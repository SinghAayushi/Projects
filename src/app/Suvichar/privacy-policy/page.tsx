  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen bg-gray-100 py-12 px-4">
      <h1 className="text-3xl font-bold text-center mb-8 ">
        Suvichar! - Privacy Policy
      </h1>
      <div className="w-full max-w-3xl text-gray-700 space-y-6">
        <p>
          <b>Suvichar!</b> is built by Aayushi Singh. This Privacy Policy
        ...
        <p>
          <b>Suvichar</b> prioritizes your privacy. We do not collect any
        ...
        <h2 className="text-2xl font-semibold mb-2 ">Information Storage</h2>
        <p>
          Your user actions and all the data of this game are stored locally on
          your device. We do not access or store this information on our
          servers. This ensures your privacy and keeps your experience entirely
          personal.
        </p>
        ...
        <p>
          ...
          However, it&apos;s important to remember that no method of
          transmission over the internet or electronic storage is 100% secure.
          While we take reasonable steps to protect your information, we cannot
          guarantee its absolute security.
        </p>

        <h2 className="text-2xl font-semibold mb-2 ">Third-Party Services</h2>
        <p>
          <b>Suvichar!</b> does not currently integrate with any third-party
